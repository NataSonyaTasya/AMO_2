...
train[['Pclass', 'Sex', 'Age', 'SibSp', 'Parch', 'Survived']].to_csv('/var/lib/jenkins/workspace/AMO_2/AMO_2/home/ubuntu/project/AMO_2/data_train.csv', index=False)
test[['Pclass', 'Sex', 'Age', 'SibSp', 'Parch']].to_csv('/var/lib/jenkins/workspace/AMO_2/AMO_2/home/ubuntu/project/AMO_2/data_test.csv', index=False)
